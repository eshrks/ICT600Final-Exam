...
<body>
    ...
    <div class="l-form">
        <form action="../process/user_add_exe.php" class="form" method="post">
            ...
            <!-- Middle Name -->
            <div class="form__div">
                <input type="text" name="middleName" class="form__input" placeholder=" ">
            ...
            <div class="form__div">
                <input type="text" name="contactNumber" class="form__input" placeholder=" ">
            ...
            <div class="form__div">
                <input type="password" name="pword" class="form__input" placeholder=" ">
